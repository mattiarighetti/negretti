...
if {$user_id == 0} {
   ad_returnredirect "login?return_url=/negretti/inventario-stamp"
}
set html "<html>"
...
append html "<table width=\"100%\" cellspacing=\"1\" cellpadding=\"1\">
                <tr>
                    <td align=\"left\"><img src=\"http://app.mattiarighetti.it/negretti/images/negretti_logo.jpg\" width=\"181px\" height=\"30px\"></img></td>
              ...
              <table width=100% border='0.2' cellspacing=3 cellpadding=3 bordercolor=grey>
               <tr> 
                  ...
                  <td align=center><font face=Helvetica><b>Prezzo</b></font></td>  
                </tr>"
db_foreach query "SELECT m.denominazione AS marca,  
 ...
 <td align=center><font size='2px'>$prezzo</font></td> "
		 }
append html "</table>"
